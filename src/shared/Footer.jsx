...
const Footer = () => {
    return (
        <div>
            <footer className="px-4 divide-y bg-orange-100 dark:bg-gray-800 dark:text-gray-100">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
            ...
            />
				...
				<span className="self-center text-2xl font-semibold">Volunteer- <span className='text-orange-400'>Hub</span></span>
			</a>
		</div>
	...
	<div className="py-6 text-sm text-center dark:text-gray-600">© 2024 Volunteer-Hub Co. All rights reserved.</div>
</footer>
