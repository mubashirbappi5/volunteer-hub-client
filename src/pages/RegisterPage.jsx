...
const RegisterPage = () => {
	...
	<div className="flex flex-col justify-between">
		<div className="space-y-2">
			<h2 className="text-4xl text-center font-bold leading-tight md:text-left lg:text-5xl">Welcome <motion.span
  animate={{ color: ['#00BFFF', '#32CD32', '#FF4500', '#6A5ACD', '#FFD700'] }}
	...
	<form onSubmit={handleregister}  className="space-y-12">
		<div className="space-y-4">
			...
			<div>
				...
				<input type="text" name="photoURL"  placeholder="Enter photo url" className="w-full px-3 py-2 border rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800" />
			</div>
			<div>
