...
const RegisterPage = () => {
	...
	<form  className="space-y-12">
		...
		<div className="space-y-2">
			<div>
				<button type="button" className=" btn w-full px-8 py-3 font-semibold text-white rounded-md dark:bg-violet-600 dark:text-gray-50 bg-orange-400">Register</button>
			</div>
